...
import TrackedPropertiesList from "@/components/property/TrackedPropertiesList";

export const dynamic = "force-dynamic";

export default async function TrackedPropertiesPage() {
    ...
    <div className="min-h-screen relative">
      ...
      <div className="relative z-10">
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 py-24">
          <h1 className="text-4xl font-bold text-white mb-8">Tracked Properties</h1>
          <TrackedPropertiesList trackedProperties={trackedProperties} />
        </div>
